...
var require_compat = __commonJS({
  "dist/compat.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.compat = void 0;
    var promises_1 = require("node:fs/promises");
    var node_process_1 = require("node:process");
    exports2.compat = {
      args: typeof globalThis.Deno !== "undefined" && globalThis.Deno ? globalThis.Deno.args : node_process_1.argv.slice(2),
      exit: (code) => {
      ...
      readTextFile: async (path) => typeof globalThis.Deno !== "undefined" && globalThis.Deno ? await globalThis.Deno.readTextFile(path) : await (0, promises_1.readFile)(path, "utf8"),
...
var require_errors = __commonJS({
  "dist/frontend/errors.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.FunctionError = exports2.AssignmentError = exports2.ResolutionError = exports2.DeclarationError = exports2.ComparisonError = exports2.CalculationError = exports2.InterpretError = exports2.ParseError = void 0;
    ...
    exports2.InterpretError = InterpretError;
    var CalculationError = class extends CustomError {
      constructor(message) {
        super(message);
      }
    };
    exports2.CalculationError = CalculationError;
    var ComparisonError = class extends CustomError {
      constructor(message) {
        super(message);
      }
    };
    exports2.ComparisonError = ComparisonError;
    var DeclarationError = class extends CustomError {
      constructor(message) {
        super(message);
      }
    };
    exports2.DeclarationError = DeclarationError;
    var ResolutionError = class extends CustomError {
      constructor(message) {
        super(message);
      }
    };
    exports2.ResolutionError = ResolutionError;
    var AssignmentError = class extends CustomError {
      constructor(message) {
        super(message);
      }
    };
    exports2.AssignmentError = AssignmentError;
    var FunctionError = class extends CustomError {
      constructor(message) {
        super(message);
      }
    };
    exports2.FunctionError = FunctionError;
  }
});

// dist/frontend/lexer.js
var require_lexer = __commonJS({
  "dist/frontend/lexer.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.TokenType = void 0;
    exports2.tokenize = tokenize;
    var compat_js_12 = require_compat();
...
var require_parser = __commonJS({
  "dist/frontend/parser.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    var Parser = class {
      ...
      ParseArgs() {
        ...
        const args2 = this.At().type == lexer_js_1.TokenType.CloseParen ? [] : this.ParseArgumentsList();
       ...
       */
      ParseArgumentsList() {
        const args2 = [this.ParseAssignmentExpression()];
        while (this.At().type == lexer_js_1.TokenType.Comma && this.Next()) {
          args2.push(this.ParseAssignmentExpression());
        }
        return args2;
      }
      /**
...
var require_values = __commonJS({
  "dist/runtime/values.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.MakeNumber = MakeNumber;
    exports2.MakeNull = MakeNull;
    exports2.MakeBool = MakeBool;
    exports2.MakeInternalCall = MakeInternalCall;
    exports2.MakeString = MakeString;
    exports2.MakeArray = MakeArray;
    exports2.MakeReturn = MakeReturn;
...
var require_statements = __commonJS({
  "dist/frontend/eval/statements.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.EvaluateProgram = EvaluateProgram;
    exports2.EvaluateVariableDeclaration = EvaluateVariableDeclaration;
    exports2.EvaluateFunctionDeclaration = EvaluateFunctionDeclaration;
    exports2.EvaluateReturnStatement = EvaluateReturnStatement;
    var interpreter_js_12 = require_interpreter();
    var values_js_1 = require_values();
    function EvaluateProgram(program, env) {
      let lastEvaluated = (0, values_js_1.MakeNull)();
      for (const statement of program.body) {
        lastEvaluated = (0, interpreter_js_12.Evaluate)(statement, env);
      }
      return lastEvaluated;
    }
    function EvaluateVariableDeclaration(declaration, env) {
      const value = declaration.value ? (0, interpreter_js_12.Evaluate)(declaration.value, env) : (0, values_js_1.MakeNull)();
    ...
    function EvaluateReturnStatement(statement, env) {
      const value = statement.value ? (0, interpreter_js_12.Evaluate)(statement.value, env) : (0, values_js_1.MakeNull)();
...
var require_functions = __commonJS({
  "dist/runtime/functions.js"(exports2) {
    "use strict";
    var __importDefault2 = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.TimeFunction = TimeFunction;
    exports2.PrintFunction = PrintFunction;
    exports2.IfFunction = IfFunction;
    exports2.NatFunction = NatFunction;
    exports2.IntFunction = IntFunction;
    exports2.FloatFunction = FloatFunction;
    exports2.StringFunction = StringFunction;
    exports2.AbsFunction = AbsFunction;
    exports2.RoundFunction = RoundFunction;
    exports2.FloorFunction = FloorFunction;
    exports2.CeilFunction = CeilFunction;
    var environment_js_12 = __importDefault2(require_environment());
    var interpreter_js_12 = require_interpreter();
    var values_js_1 = require_values();
    function TimeFunction() {
      return (0, values_js_1.MakeNumber)(Date.now());
    }
    function PrintFunction(args2) {
      const values = args2.map(valueToString);
      console.log(...values);
      return (0, values_js_1.MakeNull)();
    }
    function IfFunction(args2, env) {
      if (args2.length < 2) {
      ...
      const branchToExecute = conditionResult ? args2.length >= 2 ? args2[1] : (0, values_js_1.MakeNull)() : args2.length >= 3 ? args2[2] : (0, values_js_1.MakeNull)();
      if (branchToExecute.type === "function") {
        const fn = branchToExecute;
        const scope = new environment_js_12.default(fn.declarationEnv);
        let result = (0, values_js_1.MakeNull)();
        for (const stmt of fn.body) {
          result = (0, interpreter_js_12.Evaluate)(stmt, scope);
        }
        return result;
...
var require_environment = __commonJS({
  "dist/runtime/environment.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.CreateGlobalEnv = CreateGlobalEnv;
    var errors_js_1 = require_errors();
    var values_js_1 = require_values();
    ...
    exports2.default = Environment;
  }
});

// dist/frontend/eval/expressions.js
var require_expressions = __commonJS({
  "dist/frontend/eval/expressions.js"(exports2) {
    "use strict";
    var __importDefault2 = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.EvaluateBinaryExpression = EvaluateBinaryExpression;
    exports2.EvaluateComparisonExpression = EvaluateComparisonExpression;
    exports2.EvaluateIdentifier = EvaluateIdentifier;
    exports2.EvaluateObjectExpression = EvaluateObjectExpression;
    exports2.EvaluateIfStatement = EvaluateIfStatement;
    exports2.EvaluateCallExpression = EvaluateCallExpression;
    exports2.EvaluateAssignment = EvaluateAssignment;
    exports2.EvaluateForExpression = EvaluateForExpression;
    exports2.EvaluateWhileExpression = EvaluateWhileExpression;
    exports2.EvaluateArrayExpression = EvaluateArrayExpression;
    var interpreter_js_12 = require_interpreter();
    var values_js_1 = require_values();
    var environment_js_12 = __importDefault2(require_environment());
    var errors_js_1 = require_errors();
    function EvaluateBinaryExpression(binop, env) {
      const left = (0, interpreter_js_12.Evaluate)(binop.left, env);
      const right = (0, interpreter_js_12.Evaluate)(binop.right, env);
    ...
    function EvaluateComparisonExpression(compop, env) {
      const left = (0, interpreter_js_12.Evaluate)(compop.left, env);
      const right = (0, interpreter_js_12.Evaluate)(compop.right, env);
    ...
    function EvaluateIfExpression(callExpr, env) {
      ...
      const condition = (0, interpreter_js_12.Evaluate)(callExpr.args[0], env);
      let conditionResult = false;
      if (condition.type === "boolean") {
        conditionResult = condition.value;
      } else if (condition.type === "number") {
      ...
      if (conditionResult) {
        return (0, interpreter_js_12.Evaluate)(callExpr.args[1], env);
      } else if (callExpr.args.length >= 3) {
        return (0, interpreter_js_12.Evaluate)(callExpr.args[2], env);
      }
      return (0, values_js_1.MakeNull)();
    }
    ...
    function EvaluateObjectExpression(obj, env) {
      ...
      for (const { key, value } of obj.properties) {
        const runtimeValue = value == void 0 ? env.lookupVariable(key) : (0, interpreter_js_12.Evaluate)(value, env);
        object.properties.set(key, runtimeValue);
      }
      return object;
    }
    function EvaluateIfStatement(ifStmt, env) {
      const condition = (0, interpreter_js_12.Evaluate)(ifStmt.condition, env);
      let conditionResult = false;
      if (condition.type === "boolean") {
        conditionResult = condition.value;
      } else if (condition.type === "number") {
      ...
      if (conditionResult) {
        for (const stmt of ifStmt.thenBranch) {
          result = (0, interpreter_js_12.Evaluate)(stmt, env);
    ...
    function EvaluateCallExpression(expression, env) {
      ...
      const args2 = expression.args.map((arg) => (0, interpreter_js_12.Evaluate)(arg, env));
      const func = (0, interpreter_js_12.Evaluate)(expression.caller, env);
      if (func.type == "internal-call") {
        const result = func.call(args2, env);
        return result;
      }
      if (func.type == "function") {
        ...
        for (let i = 0; i < fn.parameters.length; i++) {
          ...
          scope.declareVariable(varname, args2[i], false);
        }
        let result = (0, values_js_1.MakeNull)();
        for (const stmt of fn.body) {
          result = (0, interpreter_js_12.Evaluate)(stmt, scope);
    ...
    function EvaluateAssignment(node, env) {
      ...
      return env.assignVariable(varname, (0, interpreter_js_12.Evaluate)(node.value, env));
    }
    function valueToString(value) {
      switch (value.type) {
        case "string":
    ...
    function EvaluateForExpression(forExpr, env) {
      const amountValue = (0, interpreter_js_12.Evaluate)(forExpr.amount, env);
    ...
    function EvaluateWhileExpression(whileExpr, env) {
      let result = (0, values_js_1.MakeNull)();
      while (true) {
        const conditionValue = (0, interpreter_js_12.Evaluate)(whileExpr.condition, env);
    ...
    function EvaluateArrayExpression(arrayExpr, env) {
      const elements = arrayExpr.elements.map((elem) => (0, interpreter_js_12.Evaluate)(elem, env));
...
var require_interpreter = __commonJS({
  "dist/runtime/interpreter.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_templates = __commonJS({
  "dist/compilation/templates.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.JAVA_TEMPLATES = void 0;
    exports2.JAVA_TEMPLATES = {
      main_class: `
...
var require_compiler = __commonJS({
  "dist/compilation/compiler.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.JavaCompiler = void 0;
    ...
    var JavaCompiler = class {
      ...
      compileFunctionDeclaration(func, context) {
        ...
        const methodBodyStatements = [];
        let hasReturned = false;
        for (let index = 0; index < func.body.length; index++) {
          const stmt = func.body[index];
          if (hasReturned) {
            break;
          }
          if (index === func.body.length - 1 && this.isExpression(stmt)) {
            methodBodyStatements.push("        return " + this.expressionToJava(stmt, context) + ";");
            hasReturned = true;
          } else {
            const compiledStmt = this.statementToJava(stmt, context);
            if (compiledStmt.trim()) {
              methodBodyStatements.push("        " + compiledStmt);
        ...
        const methodBody = methodBodyStatements.join("\n");
      ...
      /**
       * Check if a statement is a return statement or creates a return
       */
      isReturnStatement(stmt) {
        return stmt.kind === "ReturnStatement";
      }
      /**
      ...
      compileVariableDeclaration(varDecl, context) {
        ...
        if (context.isInMethod()) {
          ...
          context.addVariableType(varDecl.identifier, javaType);
        }
      }
      /**
      ...
      compileIfStatement(ifStmt, context) {
        ...
        const thenBody = ifStmt.thenBranch.map((stmt) => "            " + this.statementToJava(stmt, context)).join("\n");
        let ifCode;
        if (ifStmt.elseBranch && ifStmt.elseBranch.length > 0) {
          const elseBody = ifStmt.elseBranch.map((stmt) => "            " + this.statementToJava(stmt, context)).join("\n");
          ifCode = `if (${condition}) {
    ${thenBody}
            } else {
    ${elseBody}
    ...
    ${thenBody}
      ...
      expressionToJava(expr, context) {
        ...
        switch (expr.kind) {
          ...
          case "CallExpression": {
            const callExpr = expr;
            const args2 = callExpr.args.map((arg) => this.expressionToJava(arg, context)).join(", ");
            const callerExpr = callExpr.caller;
            if (callerExpr.kind === "Identifier") {
              switch (callerExpr.symbol) {
                case "int":
                  return `((int)Double.parseDouble(String.valueOf(${args2})))`;
                case "float":
                  return `Double.parseDouble(String.valueOf(${args2}))`;
                case "str":
                  return `String.valueOf(${args2})`;
                case "abs":
                  return `Math.abs(((Number)${args2}).doubleValue())`;
                case "round":
                  return `Math.round(((Number)${args2}).doubleValue())`;
                case "floor":
                  return `Math.floor(((Number)${args2}).doubleValue())`;
                case "ceil":
                  return `Math.ceil(((Number)${args2}).doubleValue())`;
                case "print":
                  return `System.out.println(${args2})`;
                default:
                  return `${callerExpr.symbol}(${args2})`;
              }
            }
      ...
      statementToJava(stmt, context) {
        switch (stmt.kind) {
          case "AssignmentExpression": {
            ...
            let variableName = "";
            if (assignExpr.assignee.kind === "Identifier") {
              variableName = assignExpr.assignee.symbol;
            }
            const targetType = context.getVariableType(variableName);
            if (!targetType) {
              console.warn(`No type found for variable '${variableName}', defaulting to Object`);
              return `${assignee} = ${value};`;
            }
            const castedValue = this.castValueForAssignment(value, targetType, assignExpr.value);
            return `${assignee} = ${castedValue};`;
          }
          case "CallExpression": {
            const callExpr = stmt;
            if (callExpr.caller.kind === "Identifier" && callExpr.caller.symbol === "print") {
              const args2 = callExpr.args.map((arg) => this.expressionToJava(arg, context)).join(' + " " + ');
              return this.fillTemplate("print", { ARGS: args2 });
            }
          ...
          case "ForExpression": {
            ...
            const forBody = forExpr.body.map((s) => "            " + this.statementToJava(s, context)).join("\n");
          ...
          case "WhileExpression": {
            ...
            const condition = this.expressionToJava(whileExpr.condition, context);
            const whileBody = whileExpr.body.map((s) => "            " + this.statementToJava(s, context)).join("\n");
          ...
          case "VariableDeclaration":
            this.compileVariableDeclaration(stmt, context);
            return "";
          // Already handled in compileVariableDeclaration so just return a blank
          // deno-lint-ignore no-case-declarations
          case "ReturnStatement":
            const returnExpr = stmt.expression;
            if (returnExpr) {
              return `return ${this.expressionToJava(returnExpr, context)};`;
            }
            return "return null;";
      ...
      /**
       * Cast a value to the appropriate type for assignment
       */
      castValueForAssignment(value, targetType, sourceExpr) {
        if (!targetType || targetType === "Object") {
          return value;
        }
        if (sourceExpr.kind === "BinaryExpression") {
          const binExpr = sourceExpr;
        ...
        if (sourceExpr.kind === "CallExpression") {
          const callExpr = sourceExpr;
          if (callExpr.caller.kind === "Identifier") {
            const funcName = callExpr.caller.symbol;
            if (["abs", "round", "floor", "ceil"].includes(funcName) && targetType === "int") {
              return `(int)(${value})`;
            }
          }
        }
    ...
    exports2.JavaCompiler = JavaCompiler;
...
async function denoRepl(parser, env) {
  while (true) {
    const input = prompt("> ");
...
async function nodeRepl(parser, env) {
